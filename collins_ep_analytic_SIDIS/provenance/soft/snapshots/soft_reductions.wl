...
SoftReductionChain[]:=Module[{a,b,dd,t,u,delta,aa,rr,yy,rad,lambda,kappa,
 ...
 Gate["executed Euler, Laplace, Gaussian and physical-azimuth integrals",
 ...
 Gate["standard rapidity change of variable",FullSimplify[
 ...
 Gate["regularized rapidity factors equal executed integrals",
 ...
 Gate["executed cone and jet-local rapidity integrations",FreeQ[{coneValue,injetValue},_Integrate|$Failed]];
